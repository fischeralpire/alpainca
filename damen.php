...
<body>
    ...
    <div class="container">
        ...
        <div class="product-grid">
            ...
            $query = "SELECT id, image, name, description, price FROM products WHERE category = 'Damen'";
            ...
            if ($result->num_rows > 0) {
                ...
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo "<img src='assets/products/damen/" . $row['image'] . "' alt='" . $row['name'] . "' onclick='openModal(\"assets/products/damen/" . $row['image'] . "\", \"" . $row['name'] . "\", \"" . $row['description'] . "\", \"" . $row['price'] . "\")'>";
