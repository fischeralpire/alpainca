...
<!-- Banner -->
<div class="banner">
    <img src="assets/banner/herren-banner.jpg" alt="Herren Banner">
</div>
...
<div class="container">
    ...
    <div class="product-grid">
        ...
        $query = "SELECT id, image, name, description, price FROM products WHERE category = 'Herren'";
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<img src='assets/products/herren/" . $row['image'] . "' alt='" . $row['name'] . "' onclick='openModal(\"assets/products/herren/" . $row['image'] . "\", \"" . $row['name'] . "\", \"" . $row['description'] . "\", \"" . $row['price'] . "\")'>";
